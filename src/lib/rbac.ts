...
const MODULE_ACCESS: Record<Role, NavModule[]> = {
  SUPER_ADMIN: ALL,
  SOCIO_ADMIN: ALL,
  FINANCEIRO: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "COMERCIAL", "FINANCEIRO", "METAS", "PROCESSOS", "TAREFAS"],
  COMERCIAL: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "COMERCIAL", "METAS", "PROCESSOS", "TAREFAS"],
  MARKETING: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "MARKETING", "METAS", "PROCESSOS", "TAREFAS"],
  TI: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "TI", "METAS", "PROCESSOS", "TAREFAS"],
  JURIDICO: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "JURIDICO", "COMERCIAL", "METAS", "PROCESSOS", "TAREFAS"],
