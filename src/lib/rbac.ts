...
const MODULE_ACCESS: Record<Role, NavModule[]> = {
  SUPER_ADMIN: ALL,
  SOCIO_ADMIN: ALL,
  FINANCEIRO: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "COMERCIAL", "FINANCEIRO", "METAS", "TAREFAS"],
  COMERCIAL: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "COMERCIAL", "METAS", "TAREFAS"],
  MARKETING: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "MARKETING", "METAS", "TAREFAS"],
  TI: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "TI", "METAS", "TAREFAS"],
  JURIDICO: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "JURIDICO", "COMERCIAL", "METAS", "TAREFAS"],
