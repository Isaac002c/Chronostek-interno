...
const MODULE_ACCESS: Record<Role, NavModule[]> = {
  SUPER_ADMIN: ALL,
  SOCIO_ADMIN: ALL,
  FINANCEIRO: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "COMERCIAL", "FINANCEIRO", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  COMERCIAL: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "COMERCIAL", "PROSPECCAO", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  MARKETING: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "PROSPECCAO", "MARKETING", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  TI: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "TI", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  JURIDICO: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "JURIDICO", "COMERCIAL", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  BDR: ["DASHBOARD", "CALENDARIO", "LEADS", "PROSPECCAO", "OFFICE", "TAREFAS"],
