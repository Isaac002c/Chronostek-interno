...
const MODULE_ACCESS: Record<Role, NavModule[]> = {
  ...
  COMERCIAL: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "COMERCIAL", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  MARKETING: ["DASHBOARD", "CALENDARIO", "CENTROS_CUSTO", "LEADS", "MARKETING", "METAS", "PROCESSOS", "OFFICE", "TAREFAS"],
  ...
  BDR: ["DASHBOARD", "CALENDARIO", "LEADS", "TAREFAS"],
